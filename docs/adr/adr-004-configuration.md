...
*Status*: Implemented · *Date*: 2026-04-10 · *Context*: The application had hardcoded values for host, port, model, and timeout. This is an anti-pattern that prevents different setups without recompiling and makes testing harder.
