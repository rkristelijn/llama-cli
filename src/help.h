...
constexpr const char* repl =
    ...
    "  /default      Save current model as default\n"
    "  /default <model>  Set specific model as default\n"
    "  /keep-coding  Autonomous coding mode (e.g., /keep-coding 1h)\n"
    "  /memory       Load saved memory into conversation\n"
    "  /rick         Enable Rick Sanchez personality mode\n"
